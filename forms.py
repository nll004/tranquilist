...
class NewTasklistForm(FlaskForm):
    ...
    new_tasklist_name = StringField('Task Name', validators=[InputRequired(), Length(max=30)])
...
class EditTasklistForm(FlaskForm):
    ...
    edit_tasklist_name = StringField('Task name', validators=[InputRequired(), Length(max=30)])
...
class SubtaskForm(FlaskForm):
    ...
    subtask_name = StringField('Name', validators=[InputRequired(), Length(max=30)])
